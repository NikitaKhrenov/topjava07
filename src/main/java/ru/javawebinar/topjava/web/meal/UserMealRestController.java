...
import ru.javawebinar.topjava.to.FilterDateTime;
...
//        httpHeaders.setLocation(uriOfNewResource);
    ...
    public List<UserMealWithExceed> getBetween(@RequestBody FilterDateTime filterDateTime) {
        return super.getBetween(filterDateTime.getStartDate(), filterDateTime.getStartTime(),
                filterDateTime.getEndDate(), filterDateTime.getEndTime());
    }
