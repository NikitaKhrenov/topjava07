...
@Repository("jdbcUserMealRepositoryImpl")
public class JdbcUserMealRepositoryImpl implements UserMealRepository {
    ...
    public UserMeal get(int id, int userId) {
        ...
        return meals == null ? null : DataAccessUtils.singleResult(meals);
    }

    @Override
    public List<UserMeal> getAll(int userId) {
        List<UserMeal> meals = jdbcTemplate.query("SELECT * FROM meals WHERE user_id=? ORDER BY date_time DESC", ROW_MAPPER, userId);
