        ...
        <div class="shadow">
            ...
            <div class="view-box">
                <form class="form-horizontal" method="post" id="filterForm">
                    <dl>
                        <dt>From Date:</dt>
                        <dd><input class="form-control" type="date" name="startDate" value="${startDate}"></dd>
                    </dl>
                    <dl>
                        <dt>To Date:</dt>
                        <dd><input class="form-control" type="date" name="endDate" value="${endDate}"></dd>
                    </dl>
                    <dl>
                        <dt>From Time:</dt>
                        <dd><input class="form-control" type="time" name="startTime" value="${startTime}"></dd>
                    </dl>
                    <dl>
                        <dt>To Time:</dt>
                        <dd><input class="form-control" type="time" name="endTime" value="${endTime}"></dd>
                    </dl>
